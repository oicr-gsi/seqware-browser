...
#qsub -cwd -b y -N RunReportLaneTotals -hold_jid ReportData -e error.log -o output.log -l h_vmem=8g "/u/mcheng/browsertest/node-v5.7.0-linux-x64/bin/node --max_old_space_size=8192 fpr-library.js"
